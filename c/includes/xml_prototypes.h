...
{by_Xml_sub, errors_XmlParse, findFirstTag_int_tree_string_XmlNodePointer, free_XmlParse, makeXmlTag_XmlParse_ArenaTreeNode, print_ReadOnlyBytes_XmlParse, printsAs_XmlParse};
...
struct ProtoTypes_XmlTag {
  ...
  int  (*printsAs)(                                                             // Check the print of an Xml parse tree staring at the specified tag is as expected.
    const XmlTag tag,                                                           // Starting tag
    const char * expected);                                                     // Expected print string
...
{getTag_XmlTag, node_XmlTag, print_readOnlyBytes_XmlTag, printsAs_XmlTag, tagNameIs_XmlTag_string};
