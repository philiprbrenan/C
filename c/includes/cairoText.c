...
void test0()                                                                    //TcreateImage
 {void draw(CairoTextImage i)                                                           // Draw some text
  ...
  const typeof(makeCairoTextImage(draw, 2000, 2000, "CairoText0.png", "ab32")) i = makeCairoTextImage(draw, 2000, 2000, "CairoText0.png", "ab32");                           // Create image containing some text and check its digest
  i.proto->free(i);
 }
