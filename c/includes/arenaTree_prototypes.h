...
static size_t used_ArenaTree
 (const ArenaTree list);
static ArenaTreeNode node_ArenaTreeNode_ArenaTree_string_size
 (const ArenaTree            list,
